...
_magic_number = 10
_modified_time = 1616489093.9341865
_enable_loop = True
_template_filename = '/app/lazylibrarian/data/interfaces/bookstrap/books.html'
_template_uri = 'books.html'
...
def render_headerIncludes(context):
    ...
    try:
        ...
        if perm&lazylibrarian.perm_force:
            __M_writer('        <a id="forcesearch" class="btn btn-sm btn-primary" href="forceSearch?source=books"><i class="fa fa-search"></i> Search</a>\n        <a id="forcepostprocess" class="btn btn-sm btn-primary" href="forceProcess?source=books"><i class="fa fa-cogs"></i> Run Post-Processor</a>\n        <a href="libraryScan?library=eBook" class="btn btn-sm btn-primary" id="scan"><i class="fa fa-bolt"></i> Library Scan</a>\n')
        __M_writer('        <a href="bookWall?have=0" class="button btn btn-sm btn-primary"><i class="fa fa-calendar-plus"></i> Additions</a>\n        <a href="bookWall?have=1" class="button btn btn-sm btn-primary"><i class="fa fa-calendar-alt"></i> Downloads</a>\n')
        if lazylibrarian.CONFIG['USER_ACCOUNTS'] == True:
            if lazylibrarian.CONFIG['RSS_ENABLED'] == True:
                __M_writer('            <a href="rssFeed?user=')
                __M_writer(str(user))
                __M_writer('&type=eBook&limit=10.xml" class="button btn btn-sm btn-primary" data-toggle="tooltip" title="RSS feed of recent downloads"><i class="fa fa-rss"></i></a>\n            <link rel="alternate" type="application/rss+xml" title="LazyLibrarian latest eBooks" href="rssFeed?user=')
                __M_writer(str(user))
                __M_writer('&type=eBook&limit=10.xml">\n')
            if pref&lazylibrarian.pref_myfeeds:
                __M_writer('            <a href="toggleMyFeeds" class="button btn btn-sm btn-primary" data-toggle="tooltip" title="All, or just mine"><i class="fa fa-user-circle"></i></a>\n')
            else:
                __M_writer('            <a href="toggleMyFeeds" class="button btn btn-sm btn-primary" data-toggle="tooltip" title="All, or just mine"><i class="fa fa-users"></i></a>\n')
        __M_writer('      </div>\n')
        if len(languages) > 1:
    ...
    try:
        ...
        if perm&lazylibrarian.perm_status or lazylibrarian.CONFIG['USER_ACCOUNTS']:
            ...
            if perm&lazylibrarian.perm_status:
                __M_writer('            <option value="Wanted">Wanted</option>\n            <option value="Have">Have</option>\n            <option value="Ignored">Ignored</option>\n            <option value="Skipped">Skipped</option>\n            <option value="Remove">Remove</option>\n            <option value="Delete">Delete</option>\n')
...
def render_javascriptIncludes(context):
    ...
    try:
        ...
        if perm&lazylibrarian.perm_force:
            __M_writer('                            btn = \'<p><a class="a btn btn-xs btn-danger">\' + btn + \'</a></p><p><a class="b btn btn-xs btn-success" href="searchForBook?bookid=\' + row[9] + \'&library=eBook" target="_self"><i class="fa fa-search"></i> Search</a></p>\'\n')
        else:
            __M_writer('                            btn = \'<p><a class="button btn btn-xs btn-default grey" href="requestBook?bookid=\' + row[9] + \'&library=eBook" target="_self">Request</a></p>\'\n')
        __M_writer('                    }\n                    else if ( btn.indexOf(\'Snatched\') >= 0 ) {\n                        btn = \'<a class="button btn btn-xs btn-info">Snatched</a>\'}\n                    else if ( btn.indexOf(\'Have\') >= 0 ) {\n')
        if perm&lazylibrarian.perm_status:
            __M_writer('                            btn = \'<a class="button btn btn-xs btn-info">\' + btn + \'</a>\'\n')
        else:
            __M_writer('                          btn = \'<p><a class="button btn btn-xs btn-default grey" href="requestBook?bookid=\' + row[9] + \'&library=eBook" target="_self">Request</a></p>\'\n')
        __M_writer('                        }\n                    else {\n')
        if perm&lazylibrarian.perm_status:
...
"""
__M_BEGIN_METADATA
{"filename": "/app/lazylibrarian/data/interfaces/bookstrap/books.html", "uri": "books.html", "source_encoding": "utf-8", "line_map": {"16": 2, "17": 3, "18": 4, "19": 5, "31": 0, "36": 1, "37": 4, "38": 41, "39": 114, "40": 329, "46": 5, "55": 5, "56": 9, "57": 10, "58": 14, "59": 16, "60": 17, "61": 18, "62": 18, "63": 18, "64": 19, "65": 19, "66": 21, "67": 22, "68": 23, "69": 24, "70": 27, "71": 28, "72": 29, "73": 33, "74": 34, "75": 34, "76": 34, "77": 34, "78": 34, "79": 36, "80": 39, "86": 42, "93": 42, "94": 43, "95": 43, "96": 44, "97": 45, "98": 49, "99": 51, "100": 51, "101": 53, "102": 54, "103": 58, "104": 59, "105": 66, "106": 67, "107": 73, "108": 78, "109": 79, "110": 90, "111": 96, "112": 97, "113": 98, "114": 99, "115": 101, "121": 115, "129": 115, "130": 128, "131": 128, "132": 151, "133": 152, "134": 153, "135": 154, "136": 156, "137": 179, "138": 180, "139": 185, "140": 204, "141": 205, "142": 208, "143": 210, "144": 211, "145": 212, "146": 213, "147": 215, "148": 219, "149": 220, "150": 221, "151": 222, "152": 224, "153": 226, "154": 227, "155": 228, "156": 229, "157": 231, "158": 243, "159": 243, "160": 247, "161": 247, "162": 250, "163": 251, "164": 253, "170": 164}}
__M_END_METADATA
"""
